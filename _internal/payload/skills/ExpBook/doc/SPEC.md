...
稀有度 5 階：**N / R / SR / UR / LR**（`RARITY_RANK` 1–5）。初版 **25 枚 六類**：
...
| D 代價（負面自嘲） | 億級法師(R,有效1億)／燒錢如焚(SR,$1000)／揮金如土(UR,$5000)／你知道燒了多少嗎(SR隱藏,$3000) |
| E 習慣 | 夜術士(R,0–5點task)／晨型冒險者(R,5–8點)／假日狂戰士(R,週末)／不眠騎士(SR,單日>12hr)／馬拉松(SR,單session>6hr) |
| F 隱藏/幽默 | 浴火重生(R,連3fail後達成)／惜字如金(N,<10字完task)／話癆(N,單日>50對話)／手滑藝術家(N,regress累積3次) |

- 解鎖**只進不退**（`unlocked[id]=解鎖 ts`）；隱藏徽章解鎖後才現身。
